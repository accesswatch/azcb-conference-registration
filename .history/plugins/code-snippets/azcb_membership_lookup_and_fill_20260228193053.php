    ...
    if ( (int) rgar( $form, 'id' ) !== 13 ) {
        ...
        if ( ! function_exists( 'azcb_members_csv_activate' ) ) {
            function azcb_members_csv_activate() {
                if ( defined( 'AZCB_MEMBERS_CSV_URL' ) ) {
                    return;
                }
                if ( ! get_option( 'azcb_members_csv_url' ) ) {
                    update_option( 'azcb_members_csv_url', 'https://azcb.org/wp-content/uploads/2025/10/azcb_members.csv' );
                }
            }
        }
        ...
        if ( ! function_exists( 'azcb_members_csv_uninstall' ) ) {
            function azcb_members_csv_uninstall() {
